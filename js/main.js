...
const menuProyectos = `
    <div class="chat-inline-menu" style="margin-top: 1.5rem; border-top: 1px solid var(--border-color); padding-top: 1rem;">
        <button class="chat-inline-btn" data-action="projects_infra_sistemas">⚙️ Infra & Sistemas</button>
        <button class="chat-inline-btn" data-action="projects_aplicaciones_pwa">📱 Apps & PWA</button>
        <button class="chat-inline-btn" data-action="projects_desarrollo_web">🌐 Desarrollo Web</button>
        <button class="chat-inline-btn" data-action="projects_ciberseguridad">🔐 Ciberseguridad</button>
